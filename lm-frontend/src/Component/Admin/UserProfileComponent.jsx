                ...
                <div className='px-5 border-t-2 h-64 w-full bg-[url("https://miro.medium.com/v2/resize:fit:1200/1*6Jp3vJWe7VFlFHZ9WhSJng.jpeg")]'>
                    <div className='flex justify-center'>
                        <div className='relative'>
                            {
                                isProcessing ?
                                    <img src='https://media1.tenor.com/m/64BYBgDG41QAAAAC/loading.gif' className='border-slate-950 border-2 object-cover rounded-full mt-2 h-56 w-56' />
                                    :
                            ...
                            <button onClick={(e) => handleButtonClick(e)} className='absolute border rounded-full bg-white left-3/4 top-5' disabled={isProcessing}>
