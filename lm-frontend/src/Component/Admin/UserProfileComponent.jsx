                ...
                <div className='px-5 border-t-2 h-64 w-full bg-[url("https://miro.medium.com/v2/resize:fit:1200/1*6Jp3vJWe7VFlFHZ9WhSJng.jpeg")]'>
                    <div className='flex justify-center'>
                        <div className='relative'>
                            <img className='border-slate-950 border-2 object-cover rounded-full mt-2 h-56' src={`https://drive.google.com/thumbnail?id=${url}`} alt="drive image" />
                            <button className='absolute border rounded-full bg-white left-3/4 top-5'>
