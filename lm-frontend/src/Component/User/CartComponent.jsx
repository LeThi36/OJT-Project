            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                ...
                <div class="bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
                    <div class="flex items-center justify-between w-full py-6">
                        ...
                        <h6 class="font-manrope font-medium text-2xl leading-9 text-indigo-500">{50000 * cart.length} VND</h6>
                    </div>
                </div>
                <div class="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
                    <Link to={'/'}
                        ...
                        <span class="px-2 font-semibold text-lg leading-8 text-indigo-600">Continue Browsing</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                            <path d="M8.25324 5.49609L13.7535 10.9963L8.25 16.4998" stroke="#4F46E5" stroke-width="1.6"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <button
                        class="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-indigo-600 font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">Borrow these book
