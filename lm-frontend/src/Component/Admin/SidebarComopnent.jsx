            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="my-5 h-full px-3 py-4 overflow-y-auto bg-gray-50">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href='/admin/book' className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <li>
                            <a href='/admin/user' className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                <svg className="w-[20px] h-[20px] fill-[#8e8e8e]" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <a href='/admin/author' className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <li>
                            <a href='/admin/borrow' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg className="w-[20px] h-[20px] fill-[#8e8e8e]" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
